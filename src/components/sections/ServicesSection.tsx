...
export default function ServicesSection() {
    return (
        <section id="servicios" className="relative py-24 sm:py-32 px-5 sm:px-6 bg-[#050505]">
            ...
            <div className="relative z-10 max-w-6xl mx-auto">
                ...
                <div className="text-center mb-16 sm:mb-20">
                    <motion.p
                        ...
                        className="text-[11px] font-semibold tracking-[0.2em] uppercase text-[#00f3ff] mb-4"
                    >
                        El Sistema
                    </motion.p>
                    ...
                    >
                        ...
                        <span className="text-[#00f3ff] italic">Sistema Operativo</span>
                    </motion.h2>
                ...
                <div className="flex md:grid md:grid-cols-3 gap-4 md:gap-8 overflow-x-auto snap-x snap-mandatory pb-4 md:pb-0 -mx-5 px-5 md:mx-0 md:px-0 scrollbar-hide">
                    {SERVICES.map((service, index) => (
                        <motion.div
                            ...
                            className="group relative p-8 rounded-2xl glass-premium hover:border-[#00f3ff]/30 transition-all duration-500 min-w-[85vw] md:min-w-0 snap-center"
                        >
                            {/* Icon Wrapper */}
                            <div className={`mb - 6 p - 4 rounded - xl bg - gradient - to - br ${service.gradient} w - fit`}>
                                <service.icon className="size-6 text-[#00f3ff]" />
                            </div>
                            ...
                            {'microdata' in service && (
                                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#00f3ff]/5 border border-[#00f3ff]/10">
                                    <div className="h-1.5 w-1.5 rounded-full bg-[#00f3ff]" />
                                    <span className="text-[10px] font-mono text-[#00f3ff]/80 uppercase tracking-wider">{service.microdata}</span>
                                </div>
                            )}
                            ...
                            <div className="absolute bottom-8 right-8 opacity-0 transform translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
                                <ArrowRight className="size-5 text-[#00f3ff]" />
                            </div>
                        </motion.div>
                    ))}
                </div>
            ...
            {/* Divisor inferior */}
            <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#00f3ff]/20 to-transparent" />
        </section>
    );
}
