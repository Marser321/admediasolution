...
export default function CustomCursor() {
    ...
    return (
        <div className="fixed inset-0 pointer-events-none z-[9999] overflow-hidden">
            <motion.div
                className="absolute rounded-full border border-accent-blue/60"
                style={{
                    x: cursorX,
                    y: cursorY,
                    translateX: "-50%",
                ...
                animate={{
                    ...
                    borderColor: isHovering ? "#0EA5E9" : "#38BDF8", // accent-blue : accent-light
            ...
            <motion.div
                ...
                animate={{
                    ...
                    backgroundColor: isHovering ? "#F5F0EA" : "#0EA5E9",
                }}
